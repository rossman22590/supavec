  ...
  return (
    <div className="mx-auto py-8 px-4 md:px-0">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Welcome to AI Tutor RAG API (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or
          ...
          when you use our platform, website (https://www.myapps.ai), and
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          time by contacting us at rcohen@mytsi.org.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          To exercise these rights, please contact us at rcohen@mytsi.org.
        </p>
      </section>
