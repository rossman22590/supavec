...
First, you need to download the MCP server from the [GitHub repository](https://github.com/supavec/mcp-server).
...
Let me know on [Discord](https://support.myapps.ai) or [email](mailto:rcohen@mytsi.org) if you have any questions or issues using Supavec MCP Server :)
